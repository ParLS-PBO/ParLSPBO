...
#define PARAS \
    ...
    PARA( pool_size         , int    , 5        , 0  , 100    , "size of solution pool") \
    ...
    PARA( rankpara          , int    , 30       , 0  , 100    , "same rank para") \
    PARA( sharing_period    , int    , 1e5      , 0  , 1e11   , "Max no improve steps to share") \
    ...
    PARA( gs_bound          , double , 0.15     , 0  , 1      , "global score bound") \
    PARA( gs_inc            , double , 0.000001 , 0  , 1      , "global score inc") \
